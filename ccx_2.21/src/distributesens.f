...
!     
     ...
     &     nobjectstart
!     
      real*8 xi,et,weight,xl(3,8),xs(3,2),xsj(3),shp(7,8),
...
!     
!     Loop over all elements belonging to the design variable
!     
...
!     
          do i=1,nope
            if(konl(i).eq.node) exit
          enddo
!     
!     Loop over all faces containing the design variable of the actual
!     element
!     
          loop1: do m=1,3
!     
