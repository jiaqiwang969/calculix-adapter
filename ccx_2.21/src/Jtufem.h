...
void filtermatrix_(double *au, ITG *jq, ITG *irow, ITG *icol,
                  ITG *ndesi, ITG *nodedesi,
                  double *filterrad, double *co, ITG *nk,
                  double *denominator, char *objectset,
                  double *filterval, double *xdesi,
                  double *distmin);

void filter_backward_(double *au, ITG *jq, ITG *irow, ITG *icol, 
                     ITG *ndesi, ITG *nodedesi,
                     double *dgdxglob, ITG *nobject, ITG *nk,
                     ITG *nobjectstart, char *objectset);

void filter_forward_(double *gradproj, ITG *nk, ITG *nodedesi, ITG *ndesi, 
                    char *objectset,
                    double *xo, double *yo, double *zo,
                    double *x, double *y, double *z,
                    ITG *nx, ITG *ny, ITG *nz,
                    ITG *neighbor, double *r,
                    ITG *ndesia, ITG *ndesib,
                    double *xdesi, double *distmin,
                    double *feasdir, double *filterval);

void prepackaging_(double *co, double *xo, double *yo, double *zo,
                  double *x, double *y, double *z,
                  ITG *nx, ITG *ny, ITG *nz, ITG *ifree,
                  ITG *nodedesiinv, ITG *ndesiboun,
                  ITG *nodedesiboun, char *set, ITG *nset,
                  char *objectset, ITG *iobject,
                  ITG *istartset, ITG *iendset, ITG *ialset,
                  ITG *nodenum);

void packaging_(ITG *nodedesiboun, ITG *ndesiboun, char *objectset,
                double *xo, double *yo, double *zo,
                double *x, double *y, double *z,
                ITG *nx, ITG *ny, ITG *nz,
                double *co, ITG *ifree, ITG *ndesia,
                ITG *ndesib, ITG *iobject, ITG *ndesi,
                double *dgdxglob, ITG *nk, double *extnor,
