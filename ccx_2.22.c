...
int main(int argc,char *argv[])
{
  ...
  printf("\n************************************************************\n\n");
#ifdef INTSIZE64
  printf("CalculiX Version 2.22 i8, Copyright(C) 1998-2023 Guido Dhondt\n");
#else
  printf("CalculiX Version 2.22, Copyright(C) 1998-2023 Guido Dhondt\n");
#endif
  printf("CalculiX comes with ABSOLUTELY NO WARRANTY. This is free\n");
  printf("software, and you are welcome to redistribute it under\n");
  printf("certain conditions, see gpl.htm\n\n");
  printf("************************************************************\n\n");
  printf("You are using an executable made on Wed  9 Aug 07:14:33 BST 2023\n");
  fflush(stdout);
